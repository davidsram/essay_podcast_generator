...
BGM_MOOD: dict[str, list[str]] = {
    ...
    # === 第三批（ffmpeg 生成氛围音乐 8 首，120s/首，CC0） ===
    # 钢琴氛围：静 / 夜 / 书 / 时光 / 往事 / 沉思 / 独白
    "piano_ambient": [
        "静", "夜", "晚", "时光", "光阴", "流年", "往事", "旧", "旧事",
        "沉思", "默", "独白", "心", "内心", "书", "卷", "页", "翻",
    ],
    # 大提琴氛围：深沉 / 温暖 / 记忆 / 思念 / 山河 / 异国
    "cello_drone": [
        "深沉", "温暖", "温", "记忆", "记", "思念", "思", "山河", "山河",
        "异国", "异", "他乡", "乡愁", "故", "故里", "回望", "遥", "远眺",
    ],
    # 深沉弦乐：史诗 / 人生 / 命运 / 时代 / 变迁 / 厚重
    "deep_strings": [
        "人生", "命", "命运", "时代", "年代", "世纪", "变迁", "变", "转",
        "厚重", "深", "沉", "广", "阔", "旅", "旅程", "路", "向远",
    ],
    # 笛子氛围：悠远 / 怀念 / 清晨 / 田园 / 自然 / 淡雅
    "flute_ambient": [
        "悠", "怀念", "念", "清晨", "朝", "日出", "田园", "自然", "山",
        "淡雅", "远", "遥", "风", "水", "河", "江", "湖", "海", "云",
    ],
    # 温柔民谣：家常 / 邻里 / 午后 / 温暖 / 日常 / 慢生活
    "gentle_acoustic": [
        "家常", "邻里", "邻", "午后", "下午", "暖", "温暖", "日常", "慢",
        "生活", "活", "平凡", "凡", "小", "安", "乐", "知足",
    ],
    # 冥想氛围：禅 / 入定 / 深度 / 静默 / 心境 / 空灵
    "meditation_ambient": [
        "禅", "入定", "定", "静默", "静", "默", "心", "心境", "空", "灵",
        "灵静", "修", "修行", "虚", "无", "观", "内观", "觉", "悟",
    ],
    # 五声音阶氛围：东方 / 山水 / 古风 / 淡雅 / 隽永 / 一幅画
    "pentatonic_ambient": [
        "东方", "山水", "山水", "古风", "雅", "淡雅", "隽永", "水墨",
        "画", "一幅", "墨", "色", "书香", "卷气", "文人", "雅集",
    ],
}
